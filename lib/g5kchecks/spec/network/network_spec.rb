...
describe "Network" do
  ...
  ohai.select { |dev, iface|
    ...
    it "should have the correct firmware version" do
      ver_api = @api[dev]['firmware_version'].to_s
