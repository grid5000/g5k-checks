describe "Network" do
  ...
  RSpec.configuration.node.ohai_description[:network][:interfaces].to_hash.select { |d,i| %w{ eth ib myri }.include?(i[:type]) }.each do |dev|
    ...
    it "should be the correct interface name" do
      name_api = ""
      name_api = @api[dev[0]]['interface'] if @api
    ...
    it "should have the correct Driver" do
      driver_api = ""
      driver_api = @api[dev[0]]['driver'] if @api
    ...
    it "should have the correct Rate" do
      rate_api = ""
      rate_api = @api[dev[0]]['rate'] if @api
      if dev[1][:rate] == ""
    ...
    it "should have the correct version" do
      ver_api = ""
      ver_api = @api[dev[0]]['version'] if @api
    ...
    it "should have the correct vendor" do
      ven_api = ""
      ven_api = @api[dev[0]]['vendor'] if @api
    ...
    it "should have the correct enabled mode" do
      ven_api = nil
      ven_api = @api[dev[0]]['enabled'] if @api
    ...
    it "should have the correct mountable mode" do
      ven_api = nil
      ven_api = @api[dev[0]]['mountable'] if @api
    ...
    it "should have the correct mounted mode" do
      ven_api = nil
      ven_api = @api[dev[0]]['mounted'] if @api
    ...
    it "should not be a management card" do
      mgt_api = nil
      mgt_api = @api[dev[0]]['management'] if @api
