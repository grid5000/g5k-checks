...
describe "Processor" do
  ...
  it "should have the correct frequency" do
    ...
    freq_lshw = @ohai_system[:cpu][:'0'][:mhz]
    freq_lshw.to_i.should eql(freq_api), "#{freq_lshw}, #{freq_api}, processor, clock_speed"
  ...
  it "should have the correct vendor" do
    ...
    vendor_lshw = @ohai_system[:cpu][:'0'][:vendor_id]
    vendor_lshw.to_i.should eql(vendor_api), "#{vendor_lshw}, #{vendor_api}, processor, vendor"
  end
