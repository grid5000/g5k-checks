describe 'Disk' do
  ...
  reference.each do |k, _v|
    ...
    it 'should have the correct device id' do
      ...
      by_id_api.should eql(by_id_ohai), "#{by_id_ohai}, #{by_id_api}, storage_devices, #{k}, by_id"
    end
    ...
    it 'should have the correct device path' do
      ...
      by_path_api.should eql(by_path_ohai), "#{by_path_ohai}, #{by_path_api}, storage_devices, #{k}, by_path"
    end
    ...
    it 'should have the correct size' do
      ...
      size_api.should eql(size_ohai), "#{size_ohai}, #{size_api}, storage_devices, #{k}, size"
    end

    it 'should have the correct model' do
      model_api = get_api_value(api, ohai, k, 'model')
      model_ohai = get_ohai_value(api, ohai, k, 'model')
      model_api.should eql(model_ohai), "#{model_ohai}, #{model_api}, storage_devices, #{k}, model"
    end
    ...
    it 'should have the correct revision' do
      ...
      version_api.should eql(version_ohai), "#{version_ohai}, #{version_api}, storage_devices, #{k}, rev"
    end
    ...
    it 'should have the correct vendor' do
      ...
      vendor_api.should eql(vendor_ohai), "#{vendor_ohai}, #{vendor_api}, storage_devices, #{k}, vendor"
    end
  end
end
