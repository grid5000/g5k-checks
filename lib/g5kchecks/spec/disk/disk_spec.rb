describe "Disk" do
  ...
  RSpec.configuration.node.ohai_description.block_device.select { |key,value| key =~ /[sh]d.*/ }.each_with_index do |disk,i|
    ...
    it "should have the correct name" do
      ...
      name_lshw.should eql(name_api), "#{name_lshw}, #{name_api}, block_devices, #{disk[0]}, device"
    end
    ...
    it "should have the correct size" do
      ...
      size_lshw.should eql(size_api), "#{size_lshw}, #{size_api}, block_devices, #{disk[0]}, size"
    end
    ...
    it "should have the correct model" do
      ...
      model_lshw.should eql(model_api), "#{model_lshw}, #{model_api}, block_devices, #{disk[0]}, model"
    end
    ...
    it "should have the correct revision" do
      ...
      version_lshw.should eql(version_api), "#{version_lshw}, #{version_api}, block_devices, #{disk[0]}, rev"
    end
